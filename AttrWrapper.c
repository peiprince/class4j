...
void init_attr_wrapper(AttrWrapper* pthis, ConstantItem* pconst_item, FILE* fp)
{
    ...
    if (strcmp(pthis->type, CONSTANT_VALUE) == 0)
    {
...
//        construct_deprecated_attr(p_deprecated);
//        p_deprecated->init_deprecated_attr(p_deprecated, item, p_class);
...
//        construct_rt_vis_annotation_attr(p_annotation);
//        p_annotation->init_rt_vis_annotation_attr(p_annotation, item, p_class);
